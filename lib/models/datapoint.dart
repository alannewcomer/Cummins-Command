...
class DataPoint {
  ...
  Map<String, dynamic> toFirestore() {
    ...
    void putIfPresent(String k, double? v) { if (v != null) m[k] = v; }

    // OBD2 / J1939
    putIfPresent('rpm', rpm);
    putIfPresent('speed', speed);
    putIfPresent('coolantTemp', coolantTemp);
    putIfPresent('intakeTemp', intakeTemp);
    putIfPresent('maf', maf);
    putIfPresent('throttlePos', throttlePos);
    putIfPresent('boostPressure', boostPressure);
    putIfPresent('egt', egt);
    putIfPresent('egt2', egt2);
    putIfPresent('egt3', egt3);
    putIfPresent('egt4', egt4);
    putIfPresent('transTemp', transTemp);
    putIfPresent('oilTemp', oilTemp);
    putIfPresent('oilPressure', oilPressure);
    putIfPresent('engineLoad', engineLoad);
    putIfPresent('turboSpeed', turboSpeed);
    putIfPresent('vgtPosition', vgtPosition);
    putIfPresent('egrPosition', egrPosition);
    putIfPresent('dpfSootLoad', dpfSootLoad);
    putIfPresent('dpfRegenStatus', dpfRegenStatus);
    putIfPresent('dpfDiffPressure', dpfDiffPressure);
    putIfPresent('noxPreScr', noxPreScr);
    putIfPresent('noxPostScr', noxPostScr);
    putIfPresent('defLevel', defLevel);
    putIfPresent('defTemp', defTemp);
    putIfPresent('defDosingRate', defDosingRate);
    putIfPresent('defQuality', defQuality);
    putIfPresent('railPressure', railPressure);
    putIfPresent('crankcasePressure', crankcasePressure);
    putIfPresent('coolantLevel', coolantLevel);
    putIfPresent('intercoolerOutletTemp', intercoolerOutletTemp);
    putIfPresent('exhaustBackpressure', exhaustBackpressure);
    putIfPresent('fuelRate', fuelRate);
    putIfPresent('fuelLevel', fuelLevel);
    putIfPresent('batteryVoltage', batteryVoltage);
    putIfPresent('ambientTemp', ambientTemp);
    putIfPresent('barometric', barometric);
    putIfPresent('odometer', odometer);
    putIfPresent('engineHours', engineHours);
    putIfPresent('gearRatio', gearRatio);
    putIfPresent('accelPedalD', accelPedalD);
    putIfPresent('demandTorque', demandTorque);
    putIfPresent('actualTorque', actualTorque);
    putIfPresent('referenceTorque', referenceTorque);
    putIfPresent('commandedEgr', commandedEgr);
    putIfPresent('commandedThrottle', commandedThrottle);
    putIfPresent('boostPressureCtrl', boostPressureCtrl);
    putIfPresent('vgtControlObd', vgtControlObd);
    putIfPresent('turboInletPressure', turboInletPressure);
    putIfPresent('turboInletTemp', turboInletTemp);
    putIfPresent('chargeAirTemp', chargeAirTemp);
    putIfPresent('egtObd2', egtObd2);
    putIfPresent('dpfTemp', dpfTemp);
    putIfPresent('runtimeExtended', runtimeExtended);
    // GPS
    putIfPresent('lat', lat);
    putIfPresent('lng', lng);
    putIfPresent('altitude', altitude);
    putIfPresent('gpsSpeed', gpsSpeed);
    putIfPresent('heading', heading);
    // Calculated
    putIfPresent('instantMPG', instantMPG);
    putIfPresent('estimatedGear', estimatedGear);
    putIfPresent('estimatedHP', estimatedHP);
    putIfPresent('estimatedTorque', estimatedTorque);
  ...
  factory DataPoint.fromFirestore(DocumentSnapshot doc) {
    ...
    return DataPoint.fromMap(doc.id, d);
  }
